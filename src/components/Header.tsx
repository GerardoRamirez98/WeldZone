        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="w-72 rounded-xl border bg-white pl-9 pr-3 py-2 text-sm outline-none border-zinc-300 text-zinc-900 placeholder:text-zinc-500 focus:border-yellow-500 dark:focus:border-yellow-400 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-500"
            />
          </div>
          <ThemeToggle />
        </div>
              ...
              <Dialog.Content className="fixed top-0 right-0 h-full w-64 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 shadow-lg z-50 flex flex-col p-6 animate-in slide-in-from-right duration-300">
                ...
                <div className="mt-6 relative">
                  ...
                  <input
                    ...
                    onChange={(e) => handleSearch(e.target.value)}
                    placeholder="Buscar productos."
                    className="w-full rounded-xl border bg-white dark:bg-zinc-900 pl-9 pr-3 py-2 text-sm outline-none border-zinc-300 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-500 dark:placeholder:text-zinc-500 focus:border-yellow-500 dark:focus:border-yellow-400"
                  />
                </div>
              </Dialog.Content>
            </Dialog.Portal>
